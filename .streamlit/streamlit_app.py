...
with tab4:
    ...
    with col1:
        ...
        <p style="color:#888; line-height:1.7;">
            An end-to-end house price regression system trained on the Ames Housing dataset
            from Kaggle — 79 features, 1,458 training samples. Combines regularised linear
            models with gradient boosting in a weighted ensemble, with full SHAP explainability.
        </p>
        """, unsafe_allow_html=True)

        st.markdown('<div class="section-label" style="margin-top:1.5rem">Author</div>', unsafe_allow_html=True)
        st.markdown("""
        <div class="info-card">
            <p style="font-size:1rem; font-weight:600; margin:0">Ofigwe Hart</p>
            <p style="color:#888; font-size:0.85rem; margin:4px 0 12px">Data Scientist / ML Engineer — PSP Analytics Ltd</p>
            <p style="font-size:0.85rem; margin:0">
                MSc Financial Engineering, WorldQuant University<br>
